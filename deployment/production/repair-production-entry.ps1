...
Write-Host 'FactoryBox production ana sayfa yonlendirme onarimi baslatiliyor...' -ForegroundColor Cyan
Assert-NpmLock
...
Write-Host "Ana adres artik /admin.html sayfasina yonleniyor: https://${domain}:${httpsPort}" -ForegroundColor Green
